 ...
 * @author demory
 */
public class StylizedCorridorModel extends CorridorModel {
  
  private final static Logger logger = Logger.getLogger(StylizedCorridorModel.class);
  ...
  public StylizedCorridorModel(Corridor corr) {
    super(corr);
  }
