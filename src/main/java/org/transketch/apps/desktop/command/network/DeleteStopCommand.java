/*
 * DeleteStopCommand.java
 * 
 * Created by demory on Feb 7, 2011, 11:18:51 PM
 * 
 ...
 * @author demory
 */
public class DeleteStopCommand extends EditorBasedCommand implements TSAction {

  private Stop stop_;

  public DeleteStopCommand(Editor ed, Stop stop) {
    super(ed);
    stop_ = stop;
  }
  ...
  public boolean doThis(TranSketch ts) {
    ...
    ed_.getPane().getCanvas().deletingDrawable(stop_);
    return true;
  }
