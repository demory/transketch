/*
 * RebundleCommand.java
 * 
 * Created by demory on Jan 22, 2011, 8:05:36 PM
 * 
 ...
 * @author demory
 */
public class RebundleCommand extends EditorBasedCommand {

  public RebundleCommand(Editor ed) {
    super(ed);
  }
